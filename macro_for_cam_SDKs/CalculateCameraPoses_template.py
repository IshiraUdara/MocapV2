...
def calculate_extrinsics(image_points):
    ...
    image1 = cv.imread("macro_for_cam_SDKs/Kinect_Azure_x_Kinect_OLD/tracking/cam0/1762850218.png")
    image2 = cv.imread("macro_for_cam_SDKs/Kinect_Azure_x_Kinect_OLD/tracking/cam1/1762850218.png")
